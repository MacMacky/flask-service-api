queries = {
  ...
  9 : "INSERT INTO ??(session_key,isExpired,expiration,created_at,updated_at) VALUES(?,0,(SELECT DATE_ADD(NOW(),INTERVAL 1 HOUR)),NOW(),NOW());",
  10 : "UPDATE ?? SET isExpired = 1 WHERE session_key = %s",
